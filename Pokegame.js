...
function Pokegame(props) {
  ...
  // Shuffle the Pokemon array randomly to create two hands
  const shuffledPokemon = [...pokemon].sort(() => Math.random() - 0.5);
  const hand1 = shuffledPokemon.slice(0, shuffledPokemon.length / 2);
  const hand2 = shuffledPokemon.slice(shuffledPokemon.length / 2);
